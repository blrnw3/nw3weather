...
<div id="main">
	...
	<table cellpadding="10"><tr><td style="font-weight:bold; font-size:110%">
				<a href="http://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=ILONDONL9" title="Weather Underground Hampstead PWS">
					Wunderground page
				</a><br />
			...
			<td style="font-weight:bold; font-size:110%">
				<a href="http://wow.metoffice.gov.uk/latestobservationservlet?siteID=3329071" title="Link to my UKMO WOW Site">UK Met Office WOW page<br />
					<img src="/static-images/WOWbanner.png" alt="WOW banner" /> </a>
			</td>
	</tr></table>

	<h1>My other weather-related projects</h1>

	<h2>Weather Compare App</h2>
	<p>
	...
	<p>
		I am also developing a mobile site version/application for nw3weather itself, but progress is slow due to the number of other projects on the go. <br />
		Expect a release in late 2013 at the earliest.
	</p>
	...
	<ul>
		...
		<li>	<a href="http://netbeans.org/features/php/index.html"
				title="Netbeans IDE">
				HTML/PHP/Javascript/CSS code-editing</a></li>
	</ul>
