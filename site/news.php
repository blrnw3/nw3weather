...
Page::init([
	"fileNum" => 96,
	"title" => "Blog",
	"description" => "NW3 weather website blog and news, updates and error notices.",
]);
Page::Start();
?>
	...
	<tr id="post-20260731"><td>
		...
		<p>
			<strong>Site v5 is now live</strong>. After thirteen years on site v3, nw3weather has had its biggest overhaul since 2013.
			If you are reading this on a phone, hopefully the site looks a little cleaner, and easier to read and navigate.
			The old site was deliberately fixed-width as I fiercely resisted the rise of responsive design for quite a while.
			But there are also lots of new goodies for all users, beyond the cosmetic and usability changes. 
		</p>
		...
		<p>
			...
			gathered steam in the last few months, allowing me to finally ship this update.
		</p>
		...
		<ul>
			...
			<li><b>Charts and graphs</b> — rebuilt with interactive Highcharts in place of the old static JPGraph images.
				Live 24-hour panels, selectable trends, wind roses, and historical charting are all nicer to richer and easier to use</li>
			<li><b>Homepage</b> — redesigned around live weather cards (rwcweather-like), sun/moon, a short local forecast,
				and recent charts. The forecast now comes from Yr.no rather than the old pressure-trend heuristic.</li>
			<li><b>Air pollution</b> — a new data stream: PM2.5 from nearby sensors, shown as UK DAQI on the homepage,
				and woven into graphs, reports, etc.. This is the first major new weather variable since I started out</li>
			<li><b>Detailed data &amp; rankings</b> — rain, temperature, wind, humidity, pressure and sunshine detail pages,
				plus daily/monthly/annual rankings and spell rankings (brand new), have been restyled and reworked.
				Reports and data tables are cleaner and more consistent across the site.</li>
		</ul>

		<p>
			Most of the familiar pages and features are still here just with some new style.
			Site v3 remains available and updated under <a href="/oldSites/sitev3/">oldSites/sitev3</a> for nostalgia or comparison,
			but it is no longer maintained. The same goes for even older versions.
			More background on the station and site history is on the <a href="wx8.php">About</a> page.
		</p>

		<p>
			Thank you for visiting nw3weather and I hope you enjoy some of the changes! Contact me on X or via email with feedback, as always.
			Cheers, Ben.
		</p>


		<p><span style="color:gray;font-style:italic">Posted: 31st Jul 2026</span></p>
	</td></tr>
...
<!--	<tr><td><h2>Site update - version 3 in development, now available for preview (beta?)</h2>
		...
		<li><a href="/graphviewer.php">Historical graph viewer</a> (new)</li>
	...
	<tr><td>
		...
		<img alt="graph" src="/2012/stitchedmaingraph_20120107.png" title="Daily weather graph for 7th Jan 2012 showing evidence of data reconstruction" height="1017" width="850" />
