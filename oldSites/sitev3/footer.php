...
// Link to the live (current) site equivalent of this archived page
$livePage = basename(parse_url($_SERVER['SCRIPT_NAME'], PHP_URL_PATH));
$liveHref = ($livePage !== '' && is_file(ROOT . $livePage)) ? '/' . $livePage : '/';
?>
<br />
<div id="footer">
	<div>
		<a href="#header">Top</a> |
		<a href="<?php echo ARCHIVE_WEB; ?>/contact.php" title="E-mail me">Contact</a> |
		<a href="<?php echo ARCHIVE_WEB; ?>/mob.php" title="Very basic mobile browsing">Mobile</a> |
		<a href="<?php echo ARCHIVE_WEB; ?>/" title="Archive homepage">Home</a> |
		<a href="<?php echo $liveHref; ?>" title="View this page on the current site">Current site</a>
	</div>
		<div>
...
if($ref != "" && !strContains($ref, ["nw3weather.co.uk", "www.google", "https://www.bing.com",
	"duckduckgo", "baidu", "raindrop.io", "search.yahoo", "com.google"])) {
