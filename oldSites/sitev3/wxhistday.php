...
if($todcond) {
	...
	if($sproc > mkdate(6,20,2018)) {
		echo '<a href="/oldSites/sitev3/highreswebcam.php?year='.$yproc.'&month='.$mproc.'&day='.$dproc.'&camtype=hik&light=all&width=3&freq=30&frame=1&cycle">Full resolution individual images at up-to 5 minute intervals</a><br />';
	} else {
	...
	echo "<h2>Wind rose</h2> <img src='/oldSites/sitev3/windrose.php?st=$stamp&en=$stamp' />";
}
