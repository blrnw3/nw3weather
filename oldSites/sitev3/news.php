...
<div id="main">
	...
	<tr id="post-20170906"><td>
		...
		<p>Photos of the installation process and of the new weather station are in a <a href="/oldSites/sitev3/wx_albgen.php?albnum=6&view=Full"> new photo album</a>. Favourites below:<br /><br />
		...
		<a href="/oldSites/sitev3/wx_albgen.php?albnum=6&view=Full">Full album</a>
	...
	<tr><td>
		...
		<p>
			...
			Updated values are to be found on the <a href="/oldSites/sitev3/wxaverages.php">new climate page</a>.
...
<!--	<tr><td><h2>Site update - version 3 in development, now available for preview (beta?)</h2>
		...
		Updated values found <a href="/oldSites/sitev3/wxaverages.php">here</a>. The rest of the climate averages will be updated soon to reflect the newly available 1981-2010
	...
	<tr><td><h2>Site News - two new pages, more in development</h2>
		...
		The second is a logical addition to the historical reports, <a href="/oldSites/sitev3/wxhistyear.php">annual weather summaries</a>, to compete the set which started with only daily and monthly reports.
		A summary section has been added to the <a href="/oldSites/sitev3/wxhistmonth.php#summary">monthly weather summaries</a>, though this is not yet finalised.
