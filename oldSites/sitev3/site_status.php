<?php
showStatusDiv(
	'<b>Archived website:</b> This is an old version of nw3weather, preserved for historical interest. '
	. '<a href="/" title="Visit the current nw3weather website">Visit the current site</a> '
	. 'for the latest weather data and features.',
	true
);
...
//$statusMessage = '<b>5th Sep 2017, New weather station</b>: <a href="/oldSites/sitev3/news.php" title="Read more">Data is now coming from the new sensors I installed on 4th Sep</a>. Enjoy. <a href="/oldSites/sitev3/wx_albgen.php?albnum=6&view=Full">See photos</a>';
...
//$statusMessage = '<b>'. date('d M: ', mktime(1,1,1,1,8,2019)) . '</b>'. '<a href="/oldSites/sitev3/repyear.php">nw3weather 2018 year in review is now available; click to see my weather highlights and station news</a>';
$showMessage = false;
$isBad = false;
...
//echo "<div class='statusBox info'><b>10pm, 8th May</b>: Server maintenance has completed successfully.<br />I have moved from a shared hosting solution to a cheaper, more powerful and more flexible cloud VM host<br /><a href='/oldSites/sitev3/contact.php'>Please do report any issues that may have resulted from this</a></div>";
...
if($OUTAGE) {
	if(time() < 1782786930) {
		$extraMessage = "Unfortunately we have another outage with resolution not expected before late Sunday";
	}
