...
if($sproc1 < mkdate($dmonth,$dday+1,$dyear) && $sproc > mkdate(2,0,2009) && !$toofar) {
	...
	<img src="/oldSites/sitev3/graphdayA.php?x=850&amp;y=450&amp;type2=rain&amp;type1=temp&amp;num=', $diy, '&amp;date=', date("Ymd", $sproc), '" alt="daygraph" />
	<img src="/oldSites/sitev3/graphdayA.php?x=850&amp;y=450&amp;type=hum&amp;type2=dew&amp;num=', $diy, '&amp;date=', date("Ymd", $sproc), '" alt="daygraph" />
	<img src="/oldSites/sitev3/graphday2.php?x=850&amp;y=450&amp;num=', $diy, '&amp;date=', date("Ymd", $sproc), '" alt="daygraph 2" />
	<img src="/oldSites/sitev3/graphdayA.php?x=850&amp;y=200&amp;type=wdir&amp;num=', $diy, '&amp;date=', date("Ymd", $sproc), '" alt="daygraph-wdir" />';
