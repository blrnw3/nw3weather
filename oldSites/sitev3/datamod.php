...
echo "Camlink: <a href='/oldSites/sitev3/highreswebcam.php?camtype=sky&light=day&width=6&freq=10'>Highres cam for today</a>";
...
foreach($missing as $m) {
	echo "<a href='/oldSites/sitev3/datamod.php?dtm=$m'>$m</a>, ";
}
